#ifndef _DYNAMICLOADINGSCREEN_NosLib_HPP_
#define _DYNAMICLOADINGSCREEN_NosLib_HPP_
...
namespace NosLib
{
	...
	private:
		static inline NosLib::FileManagement::FilePath FontFilePath; /* Path to the font life resource */
	...
	#pragma region InitilizeFont
		...
		static void InitilizeFont(const NosLib::FileManagement::FilePath& filePathObj = NosLib::FileManagement::FilePath(LR"(\Resources\)", L"CustomConsola.ttf"))
		{
		...
		static void InitilizeFont(std::wstring Path)
		{
			...
			InitilizeFont(NosLib::FileManagement::FilePath(Path, L"CustomConsola.ttf"));
		}
	#pragma endregion
