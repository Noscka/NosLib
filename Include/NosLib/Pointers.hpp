...
namespace NosLib
{
    ...
    namespace Pointers
    {
        ...
        template<typename T>
        inline std::add_pointer_t<NosLib::TypeTraits::remove_all_pointers_t<T>> OneOffRootPointer(const T& value)
        {
        ...
        template<typename T>
        inline NosLib::TypeTraits::remove_all_pointers_t<T> PointerRootValue(const T& value)
        {
